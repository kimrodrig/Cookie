        ...
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-md">
            ...
            <div class="flex flex-col items-center pb-10">
                ...
                <div class="flex mt-4 space-x-3 md:mt-6">
                    <p onClick={contactChef} class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 ">Message Chef</p>
                </div>
            </div>
        </div>
